...
package Flyology.Postgres.SQL.AST.V14 is
   ...
   type Field_Null;
   type Field_Null_Access is access all Field_Null;
   ...
   procedure Materialize
     ...
     with Pre =>
       Is_Valid (Arena) and then Version (Arena) = PostgreSQL_14;
