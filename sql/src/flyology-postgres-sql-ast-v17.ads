...
package Flyology.Postgres.SQL.AST.V17 is
   ...
   type Single_Partition_Spec;
   type Single_Partition_Spec_Access is access all Single_Partition_Spec;
   type Partition_Cmd;
   ...
   type Node (Kind : Node_Kind := No_Node) is record
      case Kind is
         ...
         when Node_Single_Partition_Spec =>
            Single_Partition_Spec_Payload : Single_Partition_Spec;
...
private
   ...
   procedure Materialize
     ...
     with Pre =>
       Is_Valid (Arena) and then Version (Arena) = PostgreSQL_17;
