...
package Flyology.Postgres.SQL.AST.V18 is
   ...
   type Window_Func_Run_Condition;
   type Window_Func_Run_Condition_Access is access all Window_Func_Run_Condition;
   type Merge_Support_Func;
   type Merge_Support_Func_Access is access all Merge_Support_Func;
   ...
   type Json_Format;
   type Json_Format_Access is access all Json_Format;
   type Json_Returning;
   type Json_Returning_Access is access all Json_Returning;
   type Json_Value_Expr;
   type Json_Value_Expr_Access is access all Json_Value_Expr;
   type Json_Constructor_Expr;
   type Json_Constructor_Expr_Access is access all Json_Constructor_Expr;
   type Json_Is_Predicate;
   type Json_Is_Predicate_Access is access all Json_Is_Predicate;
   type Json_Behavior;
   type Json_Behavior_Access is access all Json_Behavior;
   type Json_Expr;
   type Json_Expr_Access is access all Json_Expr;
   type Json_Table_Path;
   type Json_Table_Path_Access is access all Json_Table_Path;
   type Json_Table_Path_Scan;
   type Json_Table_Path_Scan_Access is access all Json_Table_Path_Scan;
   type Json_Table_Sibling_Join;
   type Json_Table_Sibling_Join_Access is access all Json_Table_Sibling_Join;
   type Null_Test;
   ...
   type Returning_Expr;
   type Returning_Expr_Access is access all Returning_Expr;
   type Target_Entry;
   ...
   type Rte_Permission_Info;
   type Rte_Permission_Info_Access is access all Rte_Permission_Info;
   ...
   type Returning_Option_Access is access all Returning_Option;
   type Returning_Clause;
   type Returning_Clause_Access is access all Returning_Clause;
   type Trigger_Transition;
   type Trigger_Transition_Access is access all Trigger_Transition;
   type Json_Output;
   type Json_Output_Access is access all Json_Output;
   type Json_Argument;
   type Json_Argument_Access is access all Json_Argument;
   type Json_Func_Expr;
   type Json_Func_Expr_Access is access all Json_Func_Expr;
   type Json_Table_Path_Spec;
   type Json_Table_Path_Spec_Access is access all Json_Table_Path_Spec;
   type Json_Table;
   type Json_Table_Access is access all Json_Table;
   type Json_Table_Column;
   type Json_Table_Column_Access is access all Json_Table_Column;
   type Json_Key_Value;
   type Json_Key_Value_Access is access all Json_Key_Value;
   type Json_Parse_Expr;
   type Json_Parse_Expr_Access is access all Json_Parse_Expr;
   type Json_Scalar_Expr;
   type Json_Scalar_Expr_Access is access all Json_Scalar_Expr;
   type Json_Serialize_Expr;
   type Json_Serialize_Expr_Access is access all Json_Serialize_Expr;
   type Json_Object_Constructor;
   type Json_Object_Constructor_Access is access all Json_Object_Constructor;
   type Json_Array_Constructor;
   type Json_Array_Constructor_Access is access all Json_Array_Constructor;
   type Json_Array_Query_Constructor;
   type Json_Array_Query_Constructor_Access is access all Json_Array_Query_Constructor;
   type Json_Agg_Constructor;
   type Json_Agg_Constructor_Access is access all Json_Agg_Constructor;
   type Json_Object_Agg;
   type Json_Object_Agg_Access is access all Json_Object_Agg;
   type Json_Array_Agg;
   type Json_Array_Agg_Access is access all Json_Array_Agg;
   type Raw_Stmt;
   ...
   type At_Alter_Constraint;
   type At_Alter_Constraint_Access is access all At_Alter_Constraint;
   ...
   type Optional_Json_Format_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Format_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Returning_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Returning_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Behavior_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Behavior_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Table_Path_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Table_Path_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Value_Expr_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Value_Expr_Access;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Output_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Output_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Table_Path_Spec_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Table_Path_Spec_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Agg_Constructor_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Agg_Constructor_Access;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Key_Value_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Key_Value_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Returning_Clause_Access (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Returning_Clause_Access;
         when False =>
            null;
      end case;
   end record;
   ...
   type Into_Clause is record
      ...
      View_Query : Optional_Query_Access;
   ...
   type Json_Returning is record
      Format : Optional_Json_Format_Access;
   ...
   type Json_Value_Expr is record
      ...
      Formatted_Expr : Optional_Node_Access;
      Format : Optional_Json_Format_Access;
   end record;
   ...
   type Json_Constructor_Expr is record
      ...
      Args : Sequence_Of_Node;
      Func : Optional_Node_Access;
      Coercion : Optional_Node_Access;
      Returning : Optional_Json_Returning_Access;
   ...
   type Json_Expr is record
      ...
      Formatted_Expr : Optional_Node_Access;
      Format : Optional_Json_Format_Access;
      Path_Spec : Optional_Node_Access;
      Returning : Optional_Json_Returning_Access;
      Passing_Names : Sequence_Of_Node;
      Passing_Values : Sequence_Of_Node;
      On_Empty : Optional_Json_Behavior_Access;
      On_Error : Optional_Json_Behavior_Access;
   ...
   type Json_Table_Path_Scan is record
      Plan : Optional_Node_Access;
      Path : Optional_Json_Table_Path_Access;
      Error_On_Error : Optional_Boolean;
      Child : Optional_Node_Access;
   ...
   type Json_Table_Sibling_Join is record
      Plan : Optional_Node_Access;
      Lplan : Optional_Node_Access;
      Rplan : Optional_Node_Access;
   end record;
   ...
   type Query is record
      ...
      Merge_Join_Condition : Optional_Node_Access;
      Target_List : Sequence_Of_Node;
      Override : Optional_Overriding_Kind;
   ...
   type Json_Argument is record
      Val : Optional_Json_Value_Expr_Access;
      Name : Optional_Text;
   end record;
   ...
   type Json_Func_Expr is record
      Op : Optional_Json_Expr_Op;
      Column_Name : Optional_Text;
      Context_Item : Optional_Json_Value_Expr_Access;
      Pathspec : Optional_Node_Access;
      Passing : Sequence_Of_Node;
      Output : Optional_Json_Output_Access;
      On_Empty : Optional_Json_Behavior_Access;
      On_Error : Optional_Json_Behavior_Access;
      Wrapper : Optional_Json_Wrapper;
   ...
   type Json_Table is record
      Context_Item : Optional_Json_Value_Expr_Access;
      Pathspec : Optional_Json_Table_Path_Spec_Access;
      Passing : Sequence_Of_Node;
      Columns : Sequence_Of_Node;
      On_Error : Optional_Json_Behavior_Access;
      Alias : Optional_Alias_Access;
   ...
   type Json_Key_Value is record
      Key : Optional_Node_Access;
      Value : Optional_Json_Value_Expr_Access;
   end record;

   type Json_Parse_Expr is record
      Expr : Optional_Json_Value_Expr_Access;
      Output : Optional_Json_Output_Access;
      Unique_Keys : Optional_Boolean;
      Location : Optional_Integer_32;
   end record;
   ...
   type Json_Object_Agg is record
      Constructor : Optional_Json_Agg_Constructor_Access;
      Arg : Optional_Json_Key_Value_Access;
      Absent_On_Null : Optional_Boolean;
      Unique : Optional_Boolean;
   end record;
   ...
   type Json_Array_Agg is record
      Constructor : Optional_Json_Agg_Constructor_Access;
      Arg : Optional_Json_Value_Expr_Access;
      Absent_On_Null : Optional_Boolean;
   end record;
   ...
   type Insert_Stmt is record
      ...
      Returning_Clause : Optional_Returning_Clause_Access;
   ...
   type Alter_Stats_Stmt is record
      Defnames : Sequence_Of_Node;
      Stxstattarget : Optional_Node_Access;
      Missing_Ok : Optional_Boolean;
   end record;
   ...
   type Node (Kind : Node_Kind := No_Node) is record
      case Kind is
         ...
         when Node_Window_Func_Run_Condition =>
            Window_Func_Run_Condition_Payload : Window_Func_Run_Condition;
         when Node_Merge_Support_Func =>
            Merge_Support_Func_Payload : Merge_Support_Func;
         ...
         when Node_Json_Format =>
            Json_Format_Payload : Json_Format;
         when Node_Json_Returning =>
            Json_Returning_Payload : Json_Returning;
         when Node_Json_Value_Expr =>
            Json_Value_Expr_Payload : Json_Value_Expr;
         when Node_Json_Constructor_Expr =>
            Json_Constructor_Expr_Payload : Json_Constructor_Expr;
         when Node_Json_Is_Predicate =>
            Json_Is_Predicate_Payload : Json_Is_Predicate;
         when Node_Json_Behavior =>
            Json_Behavior_Payload : Json_Behavior;
         when Node_Json_Expr =>
            Json_Expr_Payload : Json_Expr;
         when Node_Json_Table_Path =>
            Json_Table_Path_Payload : Json_Table_Path;
         when Node_Json_Table_Path_Scan =>
            Json_Table_Path_Scan_Payload : Json_Table_Path_Scan;
         when Node_Json_Table_Sibling_Join =>
            Json_Table_Sibling_Join_Payload : Json_Table_Sibling_Join;
         when Node_Null_Test =>
         ...
         when Node_Returning_Expr =>
            Returning_Expr_Payload : Returning_Expr;
         ...
         when Node_Rte_Permission_Info =>
            Rte_Permission_Info_Payload : Rte_Permission_Info;
         ...
         when Node_Returning_Option =>
            Returning_Option_Payload : Returning_Option;
         when Node_Returning_Clause =>
            Returning_Clause_Payload : Returning_Clause;
         when Node_Trigger_Transition =>
            Trigger_Transition_Payload : Trigger_Transition;
         when Node_Json_Output =>
            Json_Output_Payload : Json_Output;
         when Node_Json_Argument =>
            Json_Argument_Payload : Json_Argument;
         when Node_Json_Func_Expr =>
            Json_Func_Expr_Payload : Json_Func_Expr;
         when Node_Json_Table_Path_Spec =>
            Json_Table_Path_Spec_Payload : Json_Table_Path_Spec;
         when Node_Json_Table =>
            Json_Table_Payload : Json_Table;
         when Node_Json_Table_Column =>
            Json_Table_Column_Payload : Json_Table_Column;
         when Node_Json_Key_Value =>
            Json_Key_Value_Payload : Json_Key_Value;
         when Node_Json_Parse_Expr =>
            Json_Parse_Expr_Payload : Json_Parse_Expr;
         when Node_Json_Scalar_Expr =>
            Json_Scalar_Expr_Payload : Json_Scalar_Expr;
         when Node_Json_Serialize_Expr =>
            Json_Serialize_Expr_Payload : Json_Serialize_Expr;
         when Node_Json_Object_Constructor =>
            Json_Object_Constructor_Payload : Json_Object_Constructor;
         when Node_Json_Array_Constructor =>
            Json_Array_Constructor_Payload : Json_Array_Constructor;
         when Node_Json_Array_Query_Constructor =>
            Json_Array_Query_Constructor_Payload : Json_Array_Query_Constructor;
         when Node_Json_Agg_Constructor =>
            Json_Agg_Constructor_Payload : Json_Agg_Constructor;
         when Node_Json_Object_Agg =>
            Json_Object_Agg_Payload : Json_Object_Agg;
         when Node_Json_Array_Agg =>
            Json_Array_Agg_Payload : Json_Array_Agg;
         when Node_Raw_Stmt =>
         ...
         when Node_At_Alter_Constraint =>
            At_Alter_Constraint_Payload : At_Alter_Constraint;
   ...
   procedure Materialize
     ...
     with Pre =>
       Is_Valid (Arena) and then Version (Arena) = PostgreSQL_18;
