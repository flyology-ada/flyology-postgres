...
package body Flyology.Postgres.SQL.Native.Actions_V15_Support is
   ...
   begin
      if Name = "SplitColQualList" then
         ...
         return Action_Helper_Catalog.Execute
           (16#C5F10584B6FBC867#, Build, Arguments, Error_Location, Invoke'Access);
      elsif Name = "makeBoolAConst" then
         return Action_Helper_Catalog.Execute
           (16#388088998CFE7917#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#304D2292A38EB81C#, Build, Arguments, Error_Location, Invoke'Access);
      elsif Name = "makeIntConst" then
         return Action_Helper_Catalog.Execute
           (16#7072C3B4CC7E243D#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#7C4DA5D8FE600188#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#83234F5BCC69DC30#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#CA8FEADAF0951646#, Build, Arguments, Error_Location, Invoke'Access);
