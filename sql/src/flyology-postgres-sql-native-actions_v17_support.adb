   ...
   begin
      if Name = "SplitColQualList" then
         return Action_Helper_Catalog.Execute
           (16#F6A23DAA9B7409AC#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#5BA684059B974A83#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#8FB7C64EF63ACBF9#, Build, Arguments, Error_Location, Invoke'Access);
      elsif Name = "makeBoolAConst" then
         return Action_Helper_Catalog.Execute
           (16#4B7B023E870ED38E#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#BA53488BFF80CDFE#, Build, Arguments, Error_Location, Invoke'Access);
      elsif Name = "makeIntConst" then
         return Action_Helper_Catalog.Execute
           (16#4651436B16F8BBC7#, Build, Arguments, Error_Location, Invoke'Access);
         ...
         return Action_Helper_Catalog.Execute
           (16#58F534FEC49E6611#, Build, Arguments, Error_Location, Invoke'Access);
