...
package Flyology.Postgres.SQL.Views.V17 is
   ...
   type Json_Encoding is
     (Json_Encoding_Undefined,
      Json_Encoding_Js_Enc_Default,
      Json_Encoding_Js_Enc_Utf8,
      Json_Encoding_Js_Enc_Utf16,
      Json_Encoding_Js_Enc_Utf32);

   type Json_Format_Type is
     (Json_Format_Type_Undefined,
      Json_Format_Type_Js_Format_Default,
      Json_Format_Type_Js_Format_Json,
      Json_Format_Type_Js_Format_Jsonb);

   type Json_Constructor_Type is
   ...
   type Json_Format_Reference is private;
   type Json_Returning_Reference is private;
   ...
   type Json_Agg_Constructor_Reference is private;
   type Json_Object_Agg_Reference is private;
   type Json_Array_Agg_Reference is private;
   ...
   type Optional_Json_Format_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Format_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Returning_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Returning_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Value_Expr_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Value_Expr_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Constructor_Expr_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Constructor_Expr_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Is_Predicate_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Is_Predicate_Reference;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Rte_Permission_Info_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Rte_Permission_Info_Reference;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Output_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Output_Reference;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Object_Constructor_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Object_Constructor_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Array_Constructor_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Array_Constructor_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Array_Query_Constructor_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Array_Query_Constructor_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Agg_Constructor_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Agg_Constructor_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Object_Agg_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Object_Agg_Reference;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Array_Agg_Reference (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Array_Agg_Reference;
         when False =>
            null;
      end case;
   end record;
   ...
   type Optional_Json_Format_Type (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Format_Type;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Encoding (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Encoding;
         when False =>
   ...
   type Optional_Json_Constructor_Type (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
            Value : Json_Constructor_Type;
         when False =>
            null;
      end case;
   end record;

   type Optional_Json_Value_Type (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
   ...
   type Optional_Partition_Strategy (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
   ...
   type Optional_Unsigned_64 (Present : Standard.Boolean := False) is record
      case Present is
         when True =>
   ...
   type Node is record
      ...
      Json_Format : Optional_Json_Format_Reference;
      Json_Returning : Optional_Json_Returning_Reference;
      ...
      Json_Agg_Constructor : Optional_Json_Agg_Constructor_Reference;
      Json_Object_Agg : Optional_Json_Object_Agg_Reference;
      Json_Array_Agg : Optional_Json_Array_Agg_Reference;
   ...
   type Xml_Expr is record
      ...
      Indent : Optional_Boolean;
      Field_Type : Optional_Unsigned_32;
      Typmod : Optional_Integer_32;
      Location : Optional_Integer_32;
   end record;

   type Json_Format is record
      Format_Type : Optional_Json_Format_Type;
      Encoding : Optional_Json_Encoding;
      Location : Optional_Integer_32;
   end record;

   type Json_Returning is record
      Format : Optional_Json_Format_Reference;
      Typid : Optional_Unsigned_32;
      Typmod : Optional_Integer_32;
   end record;

   type Json_Value_Expr is record
      Raw_Expr : Optional_Node_Reference;
      Formatted_Expr : Optional_Node_Reference;
      Format : Optional_Json_Format_Reference;
   end record;

   type Json_Constructor_Expr is record
      Xpr : Optional_Node_Reference;
      Field_Type : Optional_Json_Constructor_Type;
      Args : Sequence_Of_Node;
      Func : Optional_Node_Reference;
      Coercion : Optional_Node_Reference;
      Returning : Optional_Json_Returning_Reference;
      Absent_On_Null : Optional_Boolean;
      Unique : Optional_Boolean;
      Location : Optional_Integer_32;
   end record;

   type Json_Is_Predicate is record
      Expr : Optional_Node_Reference;
      Format : Optional_Json_Format_Reference;
      Item_Type : Optional_Json_Value_Type;
   ...
   type Partition_Spec is record
      Strategy : Optional_Partition_Strategy;
   ...
   type Rte_Permission_Info is record
      Relid : Optional_Unsigned_32;
      Inh : Optional_Boolean;
      Required_Perms : Optional_Unsigned_64;
   ...
   type Json_Array_Constructor is record
      Exprs : Sequence_Of_Node;
      Output : Optional_Json_Output_Reference;
      Absent_On_Null : Optional_Boolean;
      Location : Optional_Integer_32;
   ...
   type Json_Array_Query_Constructor is record
   ...
   type Json_Agg_Constructor is record
      Output : Optional_Json_Output_Reference;
      Agg_Filter : Optional_Node_Reference;
      Agg_Order : Sequence_Of_Node;
      Over : Optional_Window_Def_Reference;
   ...
   type Json_Object_Agg is record
      Constructor : Optional_Json_Agg_Constructor_Reference;
      Arg : Optional_Json_Key_Value_Reference;
      Absent_On_Null : Optional_Boolean;
      Unique : Optional_Boolean;
   end record;

   type Json_Array_Agg is record
      Constructor : Optional_Json_Agg_Constructor_Reference;
      Arg : Optional_Json_Value_Expr_Reference;
      Absent_On_Null : Optional_Boolean;
   end record;
   ...
   type Index_Stmt is record
      ...
      Old_Number : Optional_Unsigned_32;
      Old_Create_Subid : Optional_Unsigned_32;
      Old_First_Relfilelocator_Subid : Optional_Unsigned_32;
      Unique : Optional_Boolean;
      Nulls_Not_Distinct : Optional_Boolean;
   ...
   type Node_Kind is
     (Node_Alias,
      ...
      Node_Json_Agg_Constructor,
      Node_Json_Object_Agg,
      Node_Json_Array_Agg,
      Node_Raw_Stmt,
      Node_Insert_Stmt,
      Node_Delete_Stmt,
   ...
   function As_Json_Format (Tree : Syntax_Tree; Item : Node_Reference) return Json_Format_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Format;
   function As_Json_Returning (Tree : Syntax_Tree; Item : Node_Reference) return Json_Returning_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Returning;
   function As_Json_Value_Expr (Tree : Syntax_Tree; Item : Node_Reference) return Json_Value_Expr_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Value_Expr;
   function As_Json_Constructor_Expr (Tree : Syntax_Tree; Item : Node_Reference) return Json_Constructor_Expr_Reference
   ...
   function As_Rte_Permission_Info (Tree : Syntax_Tree; Item : Node_Reference) return Rte_Permission_Info_Reference
     with Pre => Kind (Tree, Item) = Node_Rte_Permission_Info;
   ...
   function As_Json_Array_Constructor (Tree : Syntax_Tree; Item : Node_Reference) return Json_Array_Constructor_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Array_Constructor;
   function As_Json_Array_Query_Constructor (Tree : Syntax_Tree; Item : Node_Reference) return Json_Array_Query_Constructor_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Array_Query_Constructor;
   function As_Json_Agg_Constructor (Tree : Syntax_Tree; Item : Node_Reference) return Json_Agg_Constructor_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Agg_Constructor;
   function As_Json_Object_Agg (Tree : Syntax_Tree; Item : Node_Reference) return Json_Object_Agg_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Object_Agg;
   function As_Json_Array_Agg (Tree : Syntax_Tree; Item : Node_Reference) return Json_Array_Agg_Reference
     with Pre => Kind (Tree, Item) = Node_Json_Array_Agg;
   ...
   function View (Tree : Syntax_Tree; Item : Json_Format_Reference) return Json_Format;
   function View (Tree : Syntax_Tree; Item : Json_Returning_Reference) return Json_Returning;
   ...
   function View (Tree : Syntax_Tree; Item : Json_Agg_Constructor_Reference) return Json_Agg_Constructor;
   function View (Tree : Syntax_Tree; Item : Json_Object_Agg_Reference) return Json_Object_Agg;
   function View (Tree : Syntax_Tree; Item : Json_Array_Agg_Reference) return Json_Array_Agg;
...
private
   ...
   type Json_Format_Reference is record Value : Value_Id := No_Value; end record;
   type Json_Returning_Reference is record Value : Value_Id := No_Value; end record;
   ...
   type Json_Agg_Constructor_Reference is record Value : Value_Id := No_Value; end record;
   type Json_Object_Agg_Reference is record Value : Value_Id := No_Value; end record;
   type Json_Array_Agg_Reference is record Value : Value_Id := No_Value; end record;
